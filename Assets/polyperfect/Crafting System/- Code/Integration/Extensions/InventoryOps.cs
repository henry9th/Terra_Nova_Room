...
namespace Polyperfect.Crafting.Integration
{
    public static class InventoryOps
    {
        ...
        /// </summary>
        public static bool CanInsertCollectionCompletely<T>(IEnumerable<ItemStack> source, ICollection<T> destination) where T : IInsert<ItemStack>, IPeek<ItemStack>
        {
        ...
        /// </summary>
        public static List<ItemStack> RemainderAfterInsertCollection<T>(IEnumerable<ItemStack> source, ICollection<T> destination) where T : IInsert<ItemStack>, IPeek<ItemStack>
        {
