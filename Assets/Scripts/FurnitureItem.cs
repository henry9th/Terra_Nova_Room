...
public class FurnitureItem : MonoBehaviour
{
    ...
    private LayerMask invisibleGroundMask;
    ...
    public void Start() { 
        invisibleGroundMask = LayerMask.GetMask("Invisible Ground");
    ...
    public void Update() { 
        ...
        if (selected) { 
            ...
            ray = CameraButton.currentCamera.ScreenPointToRay(Input.mousePosition);
            if (Physics.Raycast(ray, out hit, float.MaxValue, invisibleGroundMask)) { 
